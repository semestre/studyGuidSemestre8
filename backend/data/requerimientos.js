...
// Ejemplo guía usado en las 7 tarjetas: un sistema de citas en línea para una clínica.
const REQUERIMIENTOS_CICLO_PRESSMAN = [
  { id: 1, title: "1. Concepción (Inception)", subtitle: "Se establece el alcance y la naturaleza general del problema.", description: "Se establece el alcance y la naturaleza general del problema. Ejemplo: una clínica pide un sistema para agendar citas en línea; el analista define que el alcance inicial cubre agendar, cancelar y recordar citas, dejando fuera la facturación. (Pressman, 2010, cap. 5)" },
  { id: 2, title: "2. Indagación / Elicitación", subtitle: "Se recopilan los requerimientos directamente de los stakeholders.", description: "Se recopilan los requerimientos directamente de los stakeholders. Ejemplo: el analista entrevista a recepcionistas y médicos, y aplica un cuestionario a pacientes para saber qué funciones esperan (recordatorios por SMS, reprogramar citas, etc.). (Pressman, 2010, cap. 5)" },
  { id: 3, title: "3. Elaboración", subtitle: "Se refinan y detallan los requerimientos; se construyen modelos.", description: "Se refinan y detallan los requerimientos; se construyen modelos. Ejemplo: se elabora un diagrama de casos de uso para \"Agendar cita\", con su flujo normal y un flujo alternativo cuando el horario elegido ya no está disponible. (Pressman, 2010, cap. 5)" },
  { id: 4, title: "4. Negociación", subtitle: "Se resuelven conflictos entre requerimientos y se priorizan (ej. MoSCoW).", description: "Se resuelven conflictos entre requerimientos y se priorizan (ej. MoSCoW). Ejemplo: TI informa que integrar el sistema con facturación tomaría dos meses extra; se negocia con la clínica y esa función se reclasifica como \"Could have\" para una segunda fase. (Pressman, 2010, cap. 5)" },
  { id: 5, title: "5. Especificación", subtitle: "Se documentan formalmente los requerimientos (ej. ERS/SRS).", description: "Se documentan formalmente los requerimientos (ej. ERS/SRS). Ejemplo: se redacta el documento SRS del sistema de citas, incluyendo el requerimiento funcional \"El sistema debe enviar un recordatorio por correo 24 horas antes de la cita\". (Pressman, 2010, cap. 5)" },
  { id: 6, title: "6. Validación", subtitle: "Se revisa que los requerimientos sean correctos, completos y consistentes.", description: "Se revisa que los requerimientos sean correctos, completos y consistentes. Ejemplo: en una revisión formal con los médicos se detecta que falta un requerimiento sobre citas de urgencia, y se agrega antes de aprobar el documento. (Pressman, 2010, cap. 5)" },
  { id: 7, title: "7. Administración de Requerimientos", subtitle: "Se gestionan los cambios y la trazabilidad durante el proyecto.", description: "Se gestionan los cambios y la trazabilidad durante el proyecto. Ejemplo: seis meses después la clínica pide agregar telemedicina; el cambio se registra como solicitud formal y se actualiza la matriz de trazabilidad para reflejar el nuevo requerimiento. (Pressman, 2010, cap. 5)" }
];
